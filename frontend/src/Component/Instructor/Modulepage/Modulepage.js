...
function Modulepage() {
  ...
  return (
    <div className="container-fluid p-0">
      ...
      <div className="modpart p-4 rounded-2 frmbg">
        <div>
              ...
              <div className="form-group-inner my-2">
                ...
                <Autocomplete
                  ...
                  renderOption={(props, option, { selected }) => {
                    ...
                    return (
                      <li key={key} {...optionProps} className="fc1">
                        <Checkbox
                          icon={icon}
                  ...
                  className="autocomplete-responsive w-100 fc1 border-0"
                  renderInput={(params) => (
                    <TextField
                      {...params}
              ...
              <div className="form-group-inner my-2">
                ...
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      placeholder="Select Learner Outcomes"
                    />
                  )}
                />
              </div>
